  ...
  portfolio: {
    ...
    projects: [
      ...
      },
      {
        ...
        tagline: "Detalhes em breve",
        description:
          "Estamos finalizando os ajustes deste projeto. Assim que estiver pronto, ele aparece aqui com todas as informações.",
        features: [],
        tech: [],
        screenshot: null,
        screenshotAlt: "Espaço reservado para o próximo projeto da JGF Company",
        href: null,
        status: "coming-soon",
      },
    ],
